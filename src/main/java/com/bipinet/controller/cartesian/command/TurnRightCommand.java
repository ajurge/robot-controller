...
/**
 * Implementation of the {@link Command} turning the {@link Cursor} to the right.
 */
    ...
    public Cursor move(Cursor cursor) {
        if (cursor == null) {
            String msg = String.format(
                    "%s is not initialised properly. Skipping turn right.",
        ...
        switch (cursor.getCurrentDirection()) {
            case UP:
                ...
                System.out.println(String.format("Current cursor direction changed to %s.", Cursor.Direction.RIGHT.name()));
                break;
            case DOWN:
                ...
                System.out.println(String.format("Setting cursor direction to %s.", Cursor.Direction.LEFT.name()));
                break;
            case RIGHT:
            ...
            case LEFT:
                ...
                break;
            default:
                System.out.println("The cursor was not turned right, because its current direction is unknown.");
                break;
        }
        return cursor;
    }
